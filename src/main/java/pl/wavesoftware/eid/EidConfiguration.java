...
/**
 * Use {@link EidConfigurator} to configure Eid settings.
 *
 * @author <a href="mailto:krzysztof.suszynski@wavesoftware.pl">Krzysztof Suszynski</a>
 * @since 2.0.0
 * @see EidConfigurator
 */
public interface EidConfiguration {
     ...
     */
    EidConfiguration uniqueIdGenerator(UniqueIdGenerator generator);
     ...
     * @return a self reference for ease of use
     */
    EidConfiguration formatter(Formatter formatter);
     ...
     */
    EidConfiguration locale(Locale locale);
     ...
     * @return a self reference for ease of use
     */
    EidConfiguration validator(Validator validator);
}
