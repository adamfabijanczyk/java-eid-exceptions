 ...
 * <pre>META-INF/services/pl.wavesoftware.eid.EidConfigurator</pre>
 *
 * In that file, place a fully qualified class name of your class that implements
 * {@link EidConfigurator} interface. It should be called first time you
 ...
 * @see ServiceLoader
 */
public interface EidConfigurator {
     ...
     */
    void configure(EidConfiguration configuration);
}
